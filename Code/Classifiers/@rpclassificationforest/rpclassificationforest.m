    ...
    methods
        ...
        function forest = growTrees(forest,nTrees,X,Y,varargin)
            ...
            [Prior,Cost,Criterion,splitmin,minparent,minleaf,...
                ...
                Robust,NWorkers,Stratified,nmix,rotate,p,dprime,Image,...
                ih,iw,F,~,extra] = ...
            ...
            parfor i = 1:nTrees
                ...
                if ~RandomForest
                    Tree{i} = rpclassregtree(Xtree(ibidx,:),Y(ibidx,:),...
                        ...
                        'nmix',nmix,'p',p,'dprime',dprime,'Image',Image,...
                        'ih',ih,'iw',iw,'F',F);
                else
