...
legWidth = axWidth;
legHeight = axHeight;
legLeft = axLeft(end) + axWidth*2/3 + FontSize*1.5;
legBottom = mean(axBottom([4,6]));
...
save_fig(gcf,[rerfPath 'RandomerForest/Figures/pami/PAMI_fig9_transformations_synthetic_data'],{'fig','pdf','png'})