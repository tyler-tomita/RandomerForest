...
ax.FontSize = 14;
ax.YTickLabel = {'RF' 'RerF' 'RR-RF' 'RerF(r)' 'F-RC'};

l = legend('1st place','2nd place','3rd place','4th place','5th place');
l.Location = 'northeast';
l.Box = 'off';

save_fig(gcf,'~/Benchmarks/Classifier_ranks_untransformed_transpose_horizontal')
...
save_fig(gcf,'~/Benchmarks/Classifier_ranks_rotated_transpose_horizontal')
...
save_fig(gcf,'~/Benchmarks/Classifier_ranks_scaled_transpose_horizontal')
...
save_fig(gcf,'~/Benchmarks/Classifier_ranks_affine_transpose_horizontal')