...
save_fig(gcf,'~/Benchmarks/Classifier_ranks_untransformed')
...
save_fig(gcf,'~/Benchmarks/Classifier_ranks_rotated')
...
save_fig(gcf,'~/Benchmarks/Classifier_ranks_scaled')
...
save_fig(gcf,'~/Benchmarks/Classifier_ranks_affine')
...
save_fig(gcf,'~/Benchmarks/Classifier_ranks_untransformed_stacked')