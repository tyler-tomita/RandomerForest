...
cbWidth = .1;
cbHeight = axHeight;
axLeft = repmat([FontSize*3,FontSize*5+axWidth,FontSize*7+2*axWidth],1,6);
...
axBottom = [(FontSize*10.5+axHeight*6)*ones(1,3),(FontSize*9+axHeight*5)*ones(1,3),...
...
%             'HorizontalAlignment','right','VerticalAlignment','top')
        if i==1
            if strcmp(Transformations{j},'Untransformed')
                text(0.5,1.05,'Raw','FontSize',16,'FontWeight','bold','Units',...
            ...
            elseif strcmp(Transformations{j},'Outlier')
                ...
                text(0.5,1.05,Transformations{j},'FontSize',16,'FontWeight','bold','Units',...
                    'normalized','HorizontalAlignment','center','VerticalAlignment'...
                    ,'bottom')
            end
            if j==1
