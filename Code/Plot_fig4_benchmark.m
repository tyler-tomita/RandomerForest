...
ax.YLim = [ymin ymax];
if xmax > 6
    ax.XTick = round(xmin:(xmax-xmin)/3:xmax);
else
    ax.XTick = xmin:xmax;
end
ax.YTick = [.9 .95 1];
% l = legend(sprintf('AUC = %0.2f',AUC.rf),sprintf('AUC = %0.2f',AUC.rerf),sprintf('AUC = %0.2f',AUC.rerfr),sprintf('AUC = %0.2f',AUC.rf_rot),sprintf('AUC = %0.2f',AUC.frc));
...
ax.YTick = [.7 .8 .9 1];
% l = legend(sprintf('AUC = %0.2f',AUC.rf),sprintf('AUC = %0.2f',AUC.rerf),sprintf('AUC = %0.2f',AUC.rerf),sprintf('AUC = %0.2f',AUC.rf_rot),sprintf('AUC = %0.2f',AUC.frc));
% l.Location = 'southeast';
% l.Box = 'off';
