...
for j = 1:length(dims)
    ...
    save(sprintf('~/RandomerForest/Results/Parity_parameter_selection_n%d_d%d.mat',n,d),'err_rf','err_rerf','err_rerfdn','err_rf_rot')
...
save('~/RandomerForest/Results/Parity.mat','sem_rf','sem_rerf','sem_rerfdn','sem_rf_rot',...
