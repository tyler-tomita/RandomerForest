%% Evaluate on Gaussian axis-aligned binary classification problem
...
for j = 1:length(ps)
    ...
    Xtest = dlmread(sprintf('~/R/Data/Gaussian/dat/Test/Gaussian_0_deg_test_set_p%d.dat',p));
    ...
    for i = 1:length(ns)
        ...
        for c = 1:length(Classifiers)
            ...
            for trial = 1:ntrials
                ...
                Xtrain = dlmread(sprintf('~/R/Data/Gaussian/dat/Train/Gaussian_0_deg_train_set_n%d_p%d_trial%d.dat',ns(i),p,trial));
            ...
            fprintf('%s complete\n',cl)
            save([rerfPath 'RandomerForest/Results/2017.06.04/Gaussian/Gaussian_0_deg_2017_06_04.mat'],'ps',...
