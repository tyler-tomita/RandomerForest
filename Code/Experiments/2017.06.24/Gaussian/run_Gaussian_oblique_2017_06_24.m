...
for j = 1:length(ps)
    ...
    Xtest = dlmread(sprintf('~/R/Data/Gaussian/dat/Test/Gaussian_oblique_test_set_p%d.dat',p));
    Ytest = cellstr(num2str(Xtest(:,end)));
    Xtest(:,end) = [];
    ClassPosteriors = dlmread(sprintf('~/R/Data/Gaussian/dat/Test/Gaussian_oblique_test_set_posteriors_p%d.dat',p));
    ...
    for i = 1:length(ns)
        ...
        for c = 1:length(Classifiers)
            ...
            for trial = 1:ntrials
                ...
                Xtrain = dlmread(sprintf('~/R/Data/Gaussian/dat/Train/Gaussian_oblique_train_set_n%d_p%d_trial%d.dat',ns(i),p,trial));
            ...
            fprintf('%s complete\n',cl)
            save([rerfPath 'RandomerForest/Results/2017.06.24/Gaussian/Gaussian_oblique_2017_06_24.mat'],'ps',...
