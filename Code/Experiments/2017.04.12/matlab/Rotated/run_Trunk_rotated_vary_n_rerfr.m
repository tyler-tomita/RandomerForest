    ...
    for i = 1:length(ns{j})
        ...
        for c = 1:length(Classifiers)
            ...
            for trial = 1:ntrials
                ...
                Xtrain = dlmread(sprintf('/scratch/groups/jvogels3/tyler/R/Data/Trunk/dat/Rotated/Train/Trunk_rotated_train_set_n%d_p%d_trial%d.dat',ns{j}(i),p,trial));
                Ytrain = cellstr(num2str(Xtrain(:,end)));
                Xtrain(:,end) = [];
                
                Xtest = dlmread(sprintf('/scratch/groups/jvogels3/tyler/R/Data/Trunk/dat/Rotated/Test/Trunk_rotated_test_set_n%d_p%d_trial%d.dat',ntest,p,trial));
