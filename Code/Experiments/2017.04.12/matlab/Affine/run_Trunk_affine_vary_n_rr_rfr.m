...
for j = 1:length(ps)
    ...
    Xtest = dlmread(sprintf('/scratch/groups/jvogels3/tyler/R/Data/Trunk/dat/Affine/Test/Trunk_test_set_p%d.dat',p));
    Ytest = cellstr(num2str(Xtest(:,end)));
    Xtest(:,end) = [];
    ClassPosteriors = dlmread(sprintf('/scratch/groups/jvogels3/tyler/R/Data/Trunk/dat/Affine/Test/Trunk_test_set_posteriors_p%d.dat',p));
    ...
    for i = 1:length(ns{j})
        ...
        for c = 1:length(Classifiers)
            ...
            for trial = 1:ntrials
                ...
                Xtrain = dlmread(sprintf('/scratch/groups/jvogels3/tyler/R/Data/Trunk/dat/Affine/Train/Trunk_train_set_n%d_p%d_trial%d.dat',ns{j}(i),p,trial));
            ...
            fprintf('%s complete\n',Classifiers{c})
            save([rerfPath 'RandomerForest/Results/2017.04.12/Trunk/Trunk_affine_vary_n_' Classifiers{c} '.mat'],'ps',...
