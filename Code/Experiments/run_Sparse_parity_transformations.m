...
for j = 1:length(dims)
    ...
    save(sprintf('~/RandomerForest/Results/Sparse_parity_transformations_n%d_d%d.mat',n,d),'err_rf','err_rerf','err_rerfr','err_rerfdn','err_rf_rot')
...
save('~/RandomerForest/Results/Sparse_parity_transformations.mat','sem_rf','sem_rerf','sem_rerfr','sem_rerfdn','sem_rf_rot',...
