...
OutFile = '~/sparse_parity_feature_importance.mat';
...
for c = 1:length(Classifiers)
    ...
    [importance,features] = feature_importance(Forest{BestIdx.(Classifiers{c})},Xtrain,Ytrain,OOBError.(Classifiers{c})(BestIdx.(Classifiers{c})));
    
    save(OutFile,'Params','OOBError','OOBAUC','TestError',...
        'TrainTime','Depth','NumNodes','NumSplitNodes','TreeStrength',...
        'TreeDiversity','BestIdx','TestScores','importance','features')
end  