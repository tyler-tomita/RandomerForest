% train and test classifiers on adult dataset

close all
clear
clc

Classifiers = {'rerfp','rerfpr','rerfpz'};

TrainFile = '/scratch/groups/jvogels3/tyler/Benchmarks/Data/uci/processed/adult.train.csv';
TestFile = '/scratch/groups/jvogels3/tyler/Benchmarks/Data/uci/processed/adult.test.csv';
OutFile = '/scratch/groups/jvogels3/tyler/RandomerForest/Results/2017.05.27/Benchmarks/adult_rerfp_2017_05_27.mat';
