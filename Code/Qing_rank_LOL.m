...
plot3(Xtrain_LOL(Ytrain==0,1),Xtrain_LOL(Ytrain==0,2),Xtrain_LOL(Ytrain==0,3),'bo',Xtrain_LOL(Ytrain==1,1),Xtrain_LOL(Ytrain==1,2),Xtrain_LOL(Ytrain==1,3),'rx',Xtest_LOL(strcmp(Yhats,'0'),1),Xtest_LOL(strcmp(Yhats,'0'),2),Xtest_LOL(strcmp(Yhats,'0'),3),'ko',Xtest_LOL(strcmp(Yhats,'1'),1),Xtest_LOL(strcmp(Yhats,'1'),2),Xtest_LOL(strcmp(Yhats,'1'),3),'kx')
set(gcf,'Visible','On')
