...
chance.error <- chance.error[no.na & (pcat == 0L)]
mean.error <- mean.error[no.na & (pcat == 0L), ]
train.time <- train.time[no.na & (pcat == 0L), ]
tree.strength <- tree.strength[no.na & (pcat == 0L), ]
tree.correlation <- tree.correlation[no.na & (pcat == 0L), ]
n <- n[no.na & (pcat == 0L)]
p <- p[no.na & (pcat == 0L)]
dataSets <- dataSets[no.na & (pcat == 0L)]
...
results <- data.frame(data.set = melt(norm.error)[[1L]], classifier = melt(norm.error)[[2L]], num.points = rep(n, length(classifiers)),
                      num.dims = rep(p, length(classifiers)), Lhat.normalized = melt(norm.error)[[3L]],
...
results.relative <- data.frame(data.set = melt(norm.rel.error)[[1L]], classifier = melt(norm.rel.error)[[2L]], num.points = rep(n, length(classifiers) - 1L),
                               num.dims = rep(p, length(classifiers) - 1L), Lhat.relative = melt(norm.rel.error)[[3L]])
...
p1 <- ggplot(df, aes(x=`relative error`)) +
  ...
  ggtitle(paste0(nrow(norm.rel.error), " UCI Benchmark Datasets"), subtitle = "No Categorical Features") +
...
ggsave(filename = "~/RandomerForest/R/Figures/2017.10.03/Benchmark_kpde_numeric_only_2017_10_03.png", plot = p1)
ggsave(filename = "~/RandomerForest/R/Figures/2017.10.03/Benchmark_kpde_numeric_only_2017_10_03.pdf", plot = p1)
...
p2 <- ggplot(cdf.plot, aes(x = `relative error`, y = kcde)) +
  ...
  theme(axis.line = element_line(size = line.width), text = element_text(size = 14), aspect.ratio = 1) +
  scale_color_manual(values = color.map)
ggsave(filename = "~/RandomerForest/R/Figures/2017.10.03/Benchmark_kcde_numeric_only_2017_10_03.png", plot = p2)
ggsave(filename = "~/RandomerForest/R/Figures/2017.10.03/Benchmark_kcde_numeric_only_2017_10_03.pdf", plot = p2)
...
ggsave(filename = "~/RandomerForest/R/Figures/2017.10.03/Benchmark_heatmap_numeric_only_2017_10_03.png", plot = p3)
ggsave(filename = "~/RandomerForest/R/Figures/2017.10.03/Benchmark_heatmap_numeric_only_2017_10_03.pdf", plot = p3)
...
p4 <- ggplot(results.relative, aes(x = num.points, y = Lhat.relative)) +
  ...
  theme(axis.line = element_line(size = line.width), text = element_text(size = 14), aspect.ratio = 1) +
  scale_color_manual(values = color.map)
ggsave(filename = "~/RandomerForest/R/Figures/2017.10.03/L_vs_n_numeric_only_2017_10_03.png", plot = p4)
ggsave(filename = "~/RandomerForest/R/Figures/2017.10.03/L_vs_n_numeric_only_2017_10_03.pdf", plot = p4)
p5 <- ggplot(results.relative, aes(x = num.dims, y = Lhat.relative)) +
  ...
  theme(axis.line = element_line(size = line.width), text = element_text(size = 14), aspect.ratio = 1) +
  scale_color_manual(values = color.map)
ggsave(filename = "~/RandomerForest/R/Figures/2017.10.03/L_vs_p_numeric_only_2017_10_03.png", plot = p5)
ggsave(filename = "~/RandomerForest/R/Figures/2017.10.03/L_vs_p_numeric_only_2017_10_03.pdf", plot = p5)
p7 <- ggplot(results.relative, aes(x = num.points/num.dims, y = Lhat.relative)) +
  ...
  theme(axis.line = element_line(size = line.width), text = element_text(size = 14), aspect.ratio = 1) +
  scale_color_manual(values = color.map)
ggsave(filename = "~/RandomerForest/R/Figures/2017.10.03/L_vs_n_over_p_numeric_only_2017_10_03.png", plot = p7)
ggsave(filename = "~/RandomerForest/R/Figures/2017.10.03/L_vs_n_over_p_numeric_only_2017_10_03.pdf", plot = p7)
p8 <- ggplot(results[results$classifier != "RerF-C", ], aes(x = corr, y = strength)) +
  ...
  theme(axis.line = element_line(size = line.width), text = element_text(size = 14), aspect.ratio = 1) +
  scale_color_manual(values = color.map)
ggsave(filename = "~/RandomerForest/R/Figures/2017.10.03/strength_correlation_numeric_only_2017_10_03.png", plot = p8)
ggsave(filename = "~/RandomerForest/R/Figures/2017.10.03/strength_correlation_numeric_only_2017_10_03.pdf", plot = p8)
