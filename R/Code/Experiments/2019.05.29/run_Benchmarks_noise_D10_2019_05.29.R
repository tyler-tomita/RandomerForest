...
for (m in classifiers) {
  ...
  for (k in seq.int(nFolds)) {
    ...
    save(testError, testAUC, OOBError, OOBAUC, trainTime, OOBTime, testTime, treeStrength, treeCorr, numNodes, bestIdx, params, file = paste0(rerfPath, "RandomerForest/R/Results/2019.05.29/", dataSet, "_noise_D10_2019_05_29.RData"))
  }
}
