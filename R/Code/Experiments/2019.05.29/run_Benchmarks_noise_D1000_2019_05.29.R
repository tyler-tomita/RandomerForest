...
dataPath2 <- "~/work/tyler/Data/uci/gaussian_noise_p1000.csv"
library(rerf)
library(AUC)
library(dummies)
...
for (m in classifiers) {
  ...
  for (k in seq.int(nFolds)) {
    ...
    save(testError, testAUC, OOBError, OOBAUC, trainTime, OOBTime, testTime, treeStrength, treeCorr, numNodes, bestIdx, params, file = paste0(rerfPath, "RandomerForest/R/Results/2019.05.29/", dataSet, "_noise_D1000_2019_05_29.RData"))
  }
}
