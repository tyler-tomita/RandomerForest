...
sed "s/abalone/${DATASET}/g" run_Benchmarks_noise_D1000_2019_05.29.R > task_D1000_${SLURM_ARRAY_TASK_ID}.R

Rscript task_D1000_${SLURM_ARRAY_TASK_ID}.R

rm task_D1000_${SLURM_ARRAY_TASK_ID}.R
