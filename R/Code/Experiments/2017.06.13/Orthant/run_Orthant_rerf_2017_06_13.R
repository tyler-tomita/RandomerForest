...
for (j in 1:length(ps)) {
  ...
  for (i in 1:length(ns[[j]])) {
    ...
    for (trial in 1:nTrials) {
      ...
      save(testError, trainTime, best.idx, params, file = paste(rerfPath, "R-RerF/Results/2017.06.13/Orthant/Orthant_rerf_2017_06_13.RData", sep = ""))
    }
  }
}
