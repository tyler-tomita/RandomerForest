  ...
  for (j in 1:length(ps)) {
    ...
    for (i in 1:length(ns[[j]])) {
      ...
      for (trial in 1:nTrials) {
        ...
        save(testError, OOBError, OOBAUC, trainTime, OOBTime, testTime, treeStrength, treeCorr, numNodes, bestIdx, params, file = paste(rerfPath, "RandomerForest/R/Results/2017.10.07/Trunk_2017_10_07.RData", sep = ""))
      }
    }
  }
}
