...
for (m in classifiers) {
  ...
  for (k in seq.int(nFolds)) {
    ...
    save(testError, testAUC, OOBError, OOBAUC, trainTime, OOBTime, testTime, treeStrength, treeCorr, numNodes, bestIdx, params, file = paste0(rerfPath, "RandomerForest/R/Results/2017.10.12/", dataSet, "_frc_2017_10_12.RData"))
  }
}
