...
\begin{center}
%\framebox[4.0in]{$\;$}
\includegraphics[trim=0in 7in .9in 6.8in, clip=true, width=0.8\linewidth]{Fig1_Lhat}
\end{center}
...
\begin{center}
%\framebox[4.0in]{$\;$}
\includegraphics[trim=0in 9.1in .9in 9.2in, clip=true, width=0.8\linewidth]{Fig2_Time}
\end{center}
...
\begin{center}
%\framebox[4.0in]{$\;$}
\includegraphics[trim=0in 9.1in .5in 9.2in, clip=true, width=0.8\linewidth]{Fig3_Invariance_v2}
\end{center}
...
\begin{center}
%\framebox[4.0in]{$\;$}
\includegraphics[trim=1.8in 9.1in 1.5in 9.2in, clip=true, width=0.7\linewidth]{Fig4}
\end{center}
