...
\item \textbf{space complexity efficiency}: when training on lots of data, storage of the classifier can become problematic;
...
Even in the absense of all these improvements, we are cautiously optimistic that RerFs may prove to be a better default classifier than RF at this time.
